...
# From: https://github.com/tuan3w/spleeter-pytorch/blob/master/spleeter/unet.py


def down_block(in_filters, out_filters):
    return nn.Conv2d(in_filters, out_filters, kernel_size=5, stride=2, padding=2,), nn.Sequential(
...
class UNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1):
        ...
        self.up7 = nn.Sequential(nn.Conv2d(1, out_channels, kernel_size=4, dilation=2, padding=3), nn.Sigmoid())
...
if __name__ == "__main__":
    ...
    net.eval()
    print(net(torch.rand(8, 1, 192, 192)).shape)
